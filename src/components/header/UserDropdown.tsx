...
export default function UserDropdown() {
  ...
  const { disconnectWallet, address, primaryRole } = useAuth();
    ...
    <div className="relative">
      ...
      >
        <div className="mb-2">
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-500 capitalize">
            {primaryRole || 'No role'}
          </span>
        </div>
        <ul className="flex flex-col gap-1 pt-2 pb-3 border-b border-gray-200">
          <li>
            <DropdownItem
              ...
              tag="a"
              to="/profile"
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-800 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-800"
            >
              <svg
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-800 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-800 w-full"
        >
          <svg
            className="fill-gray-500 group-hover:fill-gray-700"
            width="24"

...
type NavSubItem = { name: string; path: string; pro?: boolean; new?: boolean };
type NavItem = {
  name: string;
  ...
  nurse: [
    {
      ...
      name: "Dashboard",
      subItems: [
        { name: "Patient Lookup", path: "/nurse?tab=lookup" },
        { name: "Vitals Entry", path: "/nurse?tab=vitals" },
        { name: "Results Entry", path: "/nurse?tab=test" },
      ],
    },
  ],
  doctor: [
    {
      ...
      name: "Dashboard",
      subItems: [
        { name: "Patient Lookup", path: "/doctor?tab=lookup" },
        { name: "Result Review", path: "/doctor?tab=tests " },
      ],
    },
  ],
  admin: [
  ...
  receptionist: [
    {
      ...
      name: "Dashboard",
      subItems: [
        { name: "Register Patient", path: "/receptionist?tab=register" },
        { name: "Order Test/Vaccine", path: "/receptionist?tab=order" },
        { name: "View Test/Vaccine Orders", path: "/receptionist?tab=view" },
      ],
    },
  ],
  patient: [
...
const AppSidebar: React.FC = () => {
  ...
  const { primaryRole, address, isPatient } = useAuth();
  ...
  useEffect(() => {
    if (openSubmenu && openSubmenu !== null) {
